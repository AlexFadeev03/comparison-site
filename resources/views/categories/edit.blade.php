...
<div class="max-w-lg mx-auto px-4 py-6">
    <a href="{{ route('categories.index') }}" class="inline-block mb-4 text-blue-600 hover:underline">&larr; Back to categories</a>
    <div class="bg-white rounded shadow p-6">
        ...
        <form action="{{ route('categories.update', $category) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ old('name', $category->name) }}" required class="w-full border rounded px-3 py-2 focus:outline-none focus:ring" />
            </div>
            <div class="mb-4">
